...
/*2. Faça uma função para remover os n primeiros elementos de uma lista. 
A função deve retornar se a operação foi possível ou não.*/

bool retirada_n(TLList *lista, int n){
